        ...
        initSubjectTable: function () {
            ...
            subjectTableIns = table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: 'status', title: '启用状态', templet: function (res) { return res.status === 1 ? "启用" : "未启用"}},
                    {field: 'isEdit', title: '编辑状态',  templet: function (res) { return res.isEdit === 1 ? "可编辑" : "不可编辑"}},
                    {field: 'isDelete', title: '删除状态',  templet: function (res) { return res.isDelete === 1 ? "可删除" : "不可删除"}},
